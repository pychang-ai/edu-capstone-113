...
| 設備 | GPU | 顯存 | 用途 |
|------|-----|------|------|
| 主機 A | RTX 5080 | 16 GB | 主力訓練 |
| 主機 B | RTX 5060 Ti | 16 GB | 大參數模型 |
| 主機 C/D | RTX 4060 Ti | 12 GB x2 | 中型模型 |
| 主機 E/F | RTX 3060 Ti | 12 GB x2 | 學生練習 |

專題生主要使用 RTX 3060 Ti 主機練習，有需要再申請其他主機。
